...
public class Teste {
    ...
    public static void main(String[] args) throws VeicExistException {
        ...
        carros.addCarga(new Carga("BCF 234", "Ford", "Transit", "Branca", 190.00F, 4, 6, 127, 1000, 500));
        carros.addCarga(new Carga("CRT 246", "Ford", "Transit", "Preta", 210.00F, 4, 8, 152, 1150, 510));
        carros.addCarga(new Carga("GET 910", "Ford", "Ranger", "Amarela", 200.00F, 4, 12, 230, 800, 300));
